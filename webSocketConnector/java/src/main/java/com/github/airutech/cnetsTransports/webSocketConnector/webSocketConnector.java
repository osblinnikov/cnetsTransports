...
protocolToBuffer _protocolToBuffer_0;bufferToProtocol _bufferToProtocol_0;webSocket _webSocket;mapBuffer _outputProtocolBuffer_0;mapBuffer _nodeRepositoryProtocolBuffer;mapBuffer _connectionsBuffer;mapBuffer _connectionStatusBuffer_forNodes_0;mapBuffer _inputProtocolBuffer_forNodes_0;
  private void initialize(){
    
    _outputProtocolBuffer_0 = new mapBuffer((Object[])_outputProtocolBuffer_0_Arr,2000L,"0L",1,1000);
    ...
    _nodeRepositoryProtocolBuffer = new mapBuffer((Object[])_nodeRepositoryProtocolBufferArr,2000L,"1L",3,1000);
    ...
    _connectionsBuffer = new mapBuffer((Object[])_connectionsBufferArr,2000L,"2L",1,1000);
    reader _connectionsBufferr0 = _connectionsBuffer.getReader(0);
    _connectionStatusBuffer_forNodes_0 = new mapBuffer((Object[])_connectionStatusBuffer_forNodes_0_Arr,2000L,"3L",1,1000);
    ...
    _inputProtocolBuffer_forNodes_0 = new mapBuffer((Object[])_inputProtocolBuffer_forNodes_0_Arr,2000L,"4L",1,1000);
    reader _inputProtocolBuffer_forNodes_0r0 = _inputProtocolBuffer_forNodes_0.getReader(0);
    onKernels();
    
    _protocolToBuffer_0 = new protocolToBuffer(_protocolToBuffer_0_writers,_protocolToBuffer_0_writers_callbacks,_protocolToBuffer_cnt,maxNodesCount,_nodeRepositoryProtocolBufferw0,_connectionStatusBuffer_forNodes_0r0,_nodeRepositoryProtocolBufferr0,_inputProtocolBuffer_forNodes_0r0);
    _bufferToProtocol_0 = new bufferToProtocol(_bufferToProtocol_0_readers,_bufferToProtocol_0_readers_callbacks,0,maxNodesCount,_outputProtocolBuffer_0w0,_connectionStatusBuffer_forNodes_0r1,_nodeRepositoryProtocolBufferr1);
    _webSocket = new webSocket(maxNodesCount,serverUrl,-1,null,_webSocket_nodesReceivers_writers,_webSocket_connectionStatusReceivers_writers,_webSocket_buffers_readers,_outputProtocolBuffer_0r0,_connectionsBufferr0,_nodeRepositoryProtocolBufferr2);
  }
...
/*[[[end]]] (checksum: 8b52764bfbc5488d75e05448468ca29f)*/
